...
function translateToAssetResult(image: Entity) {
  if (typeof image.properties.url !== "string") {
    throw new Error(`Entity does not have a 'url' property`);
  }

  const url = image.properties.url;
...
export const App: BlockComponent<BlockEntityProperties> = ({}) => {
  ...
  const { graphService } = useGraphBlockService(cesdk_container);
